    ...
    comparisons: collection({
      ...
      schema: {
        ...
        mainSoftware: index.object({
          ...
          price: index.text({ label: "Prix" }),
          rating: index.number({
            label: "Note",
            validation: { min: 0, max: 5, isRequired: true }
          }),
          website: index.url({ label: "Site web" }),
          pros: index.array(index.text({ label: "Avantage" }), {
            label: "Avantages",
            itemLabel: (props) => props.value
          }),
          cons: index.array(index.text({ label: "Inconvénient" }), {
            label: "Inconvénients",
            itemLabel: (props) => props.value
          })
        }, {
        ...
        alternatives: index.array(
          index.object({
            name: index.text({ label: "Nom" }),
            description: index.text({ label: "Description", multiline: true }),
            logo: index.image({
              label: "Logo",
              directory: "public/images/software",
